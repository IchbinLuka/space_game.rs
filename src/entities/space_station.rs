...
use crate::{components::health::Health, materials::toon::{ApplyToonMaterial, ToonMaterial}, states::{game_running, AppState, ON_GAME_STARTED}, ui::health_bar_3d::SpawnHealthBar};

use super::{bullet::{BulletTarget, BulletType}, explosion::ExplosionEvent, spaceship::SpaceshipCollisions};
...
fn setup_space_station(
    ...
    let space_station = commands.spawn((
        SceneBundle {
...
impl Plugin for SpaceStationPlugin {
    fn build(&self, app: &mut App) {
        app
            .add_collection_to_loading_state::<_, SpaceStationRes>(AppState::MainSceneLoading)
            .add_systems(ON_GAME_STARTED, (
                setup_space_station, 
            ))
            .add_systems(Update, (
                space_station_death, 
